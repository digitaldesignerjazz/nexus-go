.PHONY: help build run doctor start-dry start-live clean tidy fmt vet
...
help:
	...
	@echo "  make start-live    ⚠️  LIVE execution mode — makes real system changes (use with extreme caution)"
...
start-live:
	@echo ""
	@echo "⚠️  WARNING: LIVE EXECUTION MODE"
